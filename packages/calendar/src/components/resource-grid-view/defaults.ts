...
export const resourceGridViewDefaults: Required<ResourceGridViewClassNames> = {
  ...
  grid: '',
  cornerCell:
    'bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 sticky top-0 left-0 z-30',
  headerCell:
    'bg-gray-50 dark:bg-gray-900 sticky top-0 z-20 flex items-center gap-2 px-3 py-2',
  headerName: 'text-gray-950 dark:text-gray-50 text-sm font-medium truncate',
  headerAvatar: 'size-6 rounded-full object-cover',
  gutterCell:
    'bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 sticky left-0 z-10 flex items-start justify-end pr-2 -mt-[0.5em]',
  gutterCellMinor:
